...
class quickrollingballgamepage extends StatefulWidget {

  String name;
  String pic;
  String email;

  quickrollingballgamepage({
    Key? key,
    required this.name,
    required this.pic,
    required this.email
  ...
  @override
  _quickrollingballgamepageState createState() => _quickrollingballgamepageState();
}

class _quickrollingballgamepageState extends State<quickrollingballgamepage> with TickerProviderStateMixin {

  bool set2 = false;
  CollectionReference reference = FirebaseFirestore.instance.collection('Rolling Ball Slide Puzzle(2)');
