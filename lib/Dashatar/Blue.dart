...
class bluedashatarpage extends StatefulWidget {
  ...
  @override
  _bluedashatarpageState createState() => _bluedashatarpageState();
}

// ignore: camel_case_types
class _bluedashatarpageState extends State<bluedashatarpage> with TickerProviderStateMixin {

  bool set2 = false;
  CollectionReference reference = FirebaseFirestore.instance.collection('Animation Slide Puzzle(2)');
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference ref = FirebaseFirestore.instance.collection(widget.name + ' Animation Slide Puzzle(2)');
