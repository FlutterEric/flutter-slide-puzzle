...
class greendashatarpage extends StatefulWidget {
  ...
  @override
  _greendashatarpageState createState() => _greendashatarpageState();
}

// ignore: camel_case_types
class _greendashatarpageState extends State<greendashatarpage> with TickerProviderStateMixin {

  bool set2 = false;
  CollectionReference reference = FirebaseFirestore.instance.collection('Animation Slide Puzzle(3)');
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference ref = FirebaseFirestore.instance.collection(widget.name + ' Animation Slide Puzzle(3)');
