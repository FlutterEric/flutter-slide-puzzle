...
class quickbluepage extends StatefulWidget {
  ...
  @override
  _quickbluepageState createState() => _quickbluepageState();
}

// ignore: camel_case_types
class _quickbluepageState extends State<quickbluepage> with TickerProviderStateMixin {
  ...
  CollectionReference reference = FirebaseFirestore.instance.collection('Quick Slide Puzzle(2)');
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference ref = FirebaseFirestore.instance.collection(widget.name + ' Quick Slide Puzzle(2)');
