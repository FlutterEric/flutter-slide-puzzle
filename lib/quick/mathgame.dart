...
// ignore: camel_case_types
class _mathgamepageState extends State<mathgamepage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference ref = FirebaseFirestore.instance.collection(widget.name + ' Quick Slide Puzzle(1)');
