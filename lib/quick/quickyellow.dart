...
class quickyellowpage extends StatefulWidget {
  ...
  @override
  _quickyellowpageState createState() => _quickyellowpageState();
}

// ignore: camel_case_types
class _quickyellowpageState extends State<quickyellowpage> with TickerProviderStateMixin {
  ...
  CollectionReference reference = FirebaseFirestore.instance.collection('Quick Slide Puzzle(4)');
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference ref = FirebaseFirestore.instance.collection(widget.name + ' Quick Slide Puzzle(4)');
