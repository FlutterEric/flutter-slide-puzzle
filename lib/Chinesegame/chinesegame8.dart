...
class _chinesegame8State extends State<chinesegame8> with TickerProviderStateMixin {
  ...
  var number = ['博', '大', '精', '深', '不', '恥', '下', '問', '不', '拘', '小', '節', '不', '屈', '不', '撓', '完', '成', '了', 0];
            ...
            children: [
              ...
              Column(
                children: [
                  Row(
                    children: [
                      set1 == true && (number[0] == '博' && number[1] == '大' &&
                          number[2] == '精' && number[3] == '深') ||
                          set1 == true &&
                              (number[4] == '博' && number[5] == '大' &&
                                  number[6] == '精' && number[7] == '深') ||
                          set1 == true &&
                              (number[8] == '博' && number[9] == '大' &&
                                  number[10] == '精' && number[11] == '深') ||
                          set1 == true &&
                              (number[12] == '博' && number[13] == '大' &&
                                  number[14] == '精' && number[15] == '深') ||
                          set1 == true &&
                              (number[16] == '博' && number[17] == '大' &&
                                  number[18] == '精' && number[19] == '深') ?
                      Row(
                        children: [
                          FadeTransition(
                            opacity: _animation,
                      ...
                      Padding(
                        ...
                        child: set1 == true && (number[0] == '不' &&
                            number[1] == '恥' && number[2] == '萬' && number[3] ==
                            '下') ||
                            set1 == true && (number[4] == '不' &&
                                number[5] == '恥' && number[6] == '下' &&
                                number[7] == '象') ||
                            set1 == true && (number[8] == '不' &&
                                number[9] == '恥' && number[10] == '下' &&
                                number[11] == '象') ||
                            set1 == true && (number[12] == '不' && number[13] ==
                                '恥' && number[14] == '下' &&
                                number[15] == '象') ||
                            set1 == true &&
                                (number[16] == '不' && number[17] == '恥' &&
                                    number[18] == '下' && number[19] == '象') ?
                        Row(
                          children: [
                            FadeTransition(
                              opacity: _animation,
