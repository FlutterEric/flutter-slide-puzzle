...
class rollingball1page extends StatefulWidget {
  ...
  @override
  _rollingball1pageState createState() => _rollingball1pageState();
}

// ignore: camel_case_types
class _rollingball1pageState extends State<rollingball1page> with TickerProviderStateMixin {

  bool set2 = false;
  CollectionReference reference = FirebaseFirestore.instance.collection('Animation Rolling Ball Slide Puzzle(1)');
